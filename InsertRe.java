	   ...
	   String Role= "Rest";
        ...
        try {
           Connection con=ConnectionUtil.getConnection();
            String query="insert into RESTAURANT(RESTNAME,RATINGS,DESCRIPTION,RESTID,ADDRESS,CITY,STATE,MOBILE,PASSWORD) values(?,?,?,?,?,?,?,?,?)";
           ...
           int n =  pmt.executeUpdate();
            if(n>0)
            {
            	if(m>0)
            	{
            	RequestDispatcher rd2 =  request.getRequestDispatcher("READD.jsp");
