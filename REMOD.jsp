...
<form action="REMOD" method="post">
     ...
     <input type="text" placeholder="New Name" name="Name">
          ...
          <div class="textbox">
           <input type="tel" id="phone" name="New Mobile" placeholder="Mobile Number">
            </div>
         ...
         <div class="textbox">
            <input type="text" placeholder="New State" name="State">
           </div>
                <div class="textbox">
            <input type="text" placeholder="New Rating" name="rating">
           </div>
                <div class="textbox">
            <input type="text" placeholder="New Description" name="descp">
           </div>
        <div class="textbox">
