...
<link href="https://fonts.googleapis.com/css2?family=Varela+Round&display=swap" rel="stylesheet">
 <%@page import="java.sql.DriverManager"%>
		...
		try{
			...
			String sql ="SELECT * FROM RESTAURANT order by RATINGS DESC";
...
<a href="Admin.jsp" >Hi,RAHUL MALI &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
...
<hr style="height: 0px; width: 0px;">
        ...
        <% while(rs.next()){ %>
		<div id="rest">
		<h2>Restaurant ID :</h2><p><%=rs.getString("RestId") %></p><br>
		<h2>Restaurant Name :</h2><p><%=rs.getString("RestName") %></p><br>
		<h2>Description :</h2><p><%=rs.getString("Description")%></p><br>
		<h2>Ratings :</h2><p><%=rs.getString("Ratings") %></p><br>
