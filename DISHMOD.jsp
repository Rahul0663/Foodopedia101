...
<body>
	...
	<hr style="border : 1px solid #2d313c;">
	<h1 id="or">Modify Dish</h1>
<div class="login-box">
    
    
    
<form action="DISHMOD" method="post">
    ...
    %>
        ...
        <div class="textbox">
        <input type="text" placeholder="New Dish Name" name="Name" required>
        </div>
        <div class="textbox">
        <input type="text" placeholder="New Details" name="Details" required>
        </div>
		...
		%>  
      <input type="submit" class="btn" value="Modify Dish" >
 </form>
 </div>
</body>
</html>